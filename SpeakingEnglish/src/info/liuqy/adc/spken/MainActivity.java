...
public class MainActivity extends TabActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        tabHost = getTabHost();
        // 创建TabSpec标签
        TabHost.TabSpec englishSpec = getTabSpec(SpeakingEnglishActivity.class,
                "说英语", android.R.drawable.btn_star_big_on);
        TabHost.TabSpec chineseSpec = getTabSpec(SpeakingChineseActivity.class,
                "Speaking Chinese", android.R.drawable.btn_star_big_on);
        // 把TabSpec添加到TabHost中
    ...
    private TabHost.TabSpec getTabSpec(Class<?> cls, String tagName, int icon)
    {
        ...
        // 设置TabSpec 的标签名与图标
        spec.setIndicator(tagName, getResources().getDrawable(icon));
