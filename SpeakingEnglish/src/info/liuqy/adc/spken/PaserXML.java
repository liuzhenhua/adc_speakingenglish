...
public class PaserXML
{
    class DFA
    {
        public static final int INIT_STATE = 0, EXPR_TAG = 1, CN_TAG = 2,
    ...
    public Map<String, String> loadExpressionsFromXml(Context context,
            int dfaTag, int resourceId) throws XmlPullParserException,
            IOException
    {
